...
function configureStore() {
  return redux.createStore(rootReducer, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
}
...
var CanvasAnnotation = function CanvasAnnotation(_ref) {
  ...
  var imageData = React.useMemo(function () {
    return _extends({
      fileData: imageFile,
      loadStatus: false
    }, labelsData);
  ...
  var _useSelector = reactRedux.useSelector(selector, isEqual),
  ...
  return React__default.createElement(Container, {
    className: className
  }, React__default.createElement(EditorWrapper, null, imageData && React__default.createElement(Editor, {
    ...
    renderTrackHorizontal: function renderTrackHorizontal(props) {
      return React__default.createElement(NoCursorTrack, Object.assign({}, props));
    },
  ...
  })), React__default.createElement(MouseIndicator, {
...
}, styledTools.ifProp("isTransform", {
  "borderWidth": "1px",
...
var ReactCanvasAnnotation = function ReactCanvasAnnotation(props) {
  return React__default.createElement(reactRedux.Provider, {
    store: store
  }, React__default.createElement(CanvasAnnotation, Object.assign({}, props)));
};

module.exports = ReactCanvasAnnotation;
